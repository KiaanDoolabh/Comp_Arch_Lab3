...
module testbench();
  ...
  string initialdata;
        ...
        //memfilename = {"../generated_test.memfile"};
        //memfilename = {"../swlw.memfile"};
        //memfilename = {"../testing/sh.memfile"};
        initialdata = {"../initialdmem.memfile"};
        $readmemh(memfilename, dut.imem.RAM);
        $readmemh(initialdata, dut.dmem.RAM);
     end
...
module maindec (input  logic [6:0] op,
   ...
   always_comb
     case(op)
       ...
       7'b0010111: controls = 12'b1_100_1_0_11_0_00_0; // auipc
